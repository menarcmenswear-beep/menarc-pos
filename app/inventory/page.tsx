...
export default function InventoryManagement() {
  ...
  const [newSupplier, setNewSupplier] = useState('Kinsey Knitt');
    ...
    <div className="min-h-screen bg-neutral-950 text-white p-6 md:p-10 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleAddProduct} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <input type="text" placeholder="Kinsey Knitt" className="bg-neutral-950 border border-neutral-700 rounded p-2 text-sm text-white focus:outline-none focus:border-white w-full" value={newSupplier} onChange={(e) => setNewSupplier(e.target.value)} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div>
          ...
          {/* Inventory Table List with Export & Filters */}
