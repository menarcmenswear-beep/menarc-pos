        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-2">
              ...
              <button
                onClick={() => addToCart()}
                className="bg-white text-black font-bold px-6 py-3.5 rounded-lg hover:bg-neutral-200 active:scale-95 transition text-sm shrink-0"
              >
                Add
              </button>
            </div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-xl flex flex-col justify-between min-h-[340px] shadow-lg">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="flex items-center gap-2 font-bold text-base text-neutral-200">
                    <ShoppingCart size={16} /> Current Cart
                  </h2>
